...
const TOP_STOCKS: { symbol: string; name: string; weight: number }[] = [
  // Mega cap (compressed weights — order reflects actual market cap ranking, Mar 2026)
  { symbol: 'NVDA', name: 'NVIDIA', weight: 1400 },
  { symbol: 'AAPL', name: 'Apple', weight: 1350 },
  ...
  // Large cap
  { symbol: 'JPM', name: 'JPMorgan', weight: 520 },
  { symbol: 'WMT', name: 'Walmart', weight: 500 },
  { symbol: 'V', name: 'Visa', weight: 480 },
  { symbol: 'XOM', name: 'ExxonMobil', weight: 460 },
  { symbol: 'UNH', name: 'UnitedHealth', weight: 440 },
  { symbol: 'MA', name: 'Mastercard', weight: 420 },
  { symbol: 'ORCL', name: 'Oracle', weight: 400 },
  { symbol: 'COST', name: 'Costco', weight: 390 },
  { symbol: 'HD', name: 'Home Depot', weight: 380 },
  { symbol: 'PG', name: 'Procter & Gamble', weight: 370 },
  { symbol: 'JNJ', name: 'Johnson & Johnson', weight: 360 },
  { symbol: 'NFLX', name: 'Netflix', weight: 350 },
  { symbol: 'ABBV', name: 'AbbVie', weight: 340 },
  ...
  { symbol: 'NOW', name: 'ServiceNow', weight: 215 },
  { symbol: 'CSCO', name: 'Cisco', weight: 210 },
  { symbol: 'WFC', name: 'Wells Fargo', weight: 205 },
  { symbol: 'MCD', name: 'McDonald\'s', weight: 200 },
  { symbol: 'IBM', name: 'IBM', weight: 198 },
  { symbol: 'GE', name: 'GE Aerospace', weight: 195 },
  { symbol: 'LIN', name: 'Linde', weight: 190 },
  { symbol: 'ISRG', name: 'Intuitive Surgical', weight: 185 },
  { symbol: 'CAT', name: 'Caterpillar', weight: 180 },
  { symbol: 'INTU', name: 'Intuit', weight: 175 },
  { symbol: 'DIS', name: 'Disney', weight: 172 },
  { symbol: 'QCOM', name: 'Qualcomm', weight: 170 },
  { symbol: 'AXP', name: 'American Express', weight: 168 },
  { symbol: 'VZ', name: 'Verizon', weight: 165 },
  { symbol: 'UBER', name: 'Uber', weight: 162 },
  { symbol: 'GS', name: 'Goldman Sachs', weight: 160 },
  { symbol: 'TXN', name: 'Texas Instruments', weight: 158 },
  { symbol: 'PLTR', name: 'Palantir', weight: 155 },
  { symbol: 'BKNG', name: 'Booking Holdings', weight: 152 },
  { symbol: 'PFE', name: 'Pfizer', weight: 148 },
  { symbol: 'SPGI', name: 'S&P Global', weight: 145 },
  { symbol: 'BA', name: 'Boeing', weight: 142 },
  { symbol: 'NKE', name: 'Nike', weight: 140 },
  { symbol: 'T', name: 'AT&T', weight: 138 },
  { symbol: 'MS', name: 'Morgan Stanley', weight: 135 },
  { symbol: 'HON', name: 'Honeywell', weight: 132 },
  { symbol: 'AMGN', name: 'Amgen', weight: 130 },
  { symbol: 'LOW', name: 'Lowe\'s', weight: 128 },
  { symbol: 'BLK', name: 'BlackRock', weight: 125 },
  { symbol: 'RTX', name: 'RTX Corp', weight: 122 },
  { symbol: 'PYPL', name: 'PayPal', weight: 120 },
  { symbol: 'NEE', name: 'NextEra Energy', weight: 118 },
  { symbol: 'SBUX', name: 'Starbucks', weight: 115 },
  { symbol: 'AMAT', name: 'Applied Materials', weight: 112 },
  { symbol: 'UPS', name: 'UPS', weight: 110 },
  { symbol: 'DE', name: 'John Deere', weight: 108 },
  { symbol: 'SCHW', name: 'Charles Schwab', weight: 106 },
  { symbol: 'INTC', name: 'Intel', weight: 104 },
  { symbol: 'SYK', name: 'Stryker', weight: 102 },
  { symbol: 'MDT', name: 'Medtronic', weight: 100 },
  { symbol: 'ADP', name: 'ADP', weight: 98 },
  { symbol: 'GILD', name: 'Gilead Sciences', weight: 96 },
  { symbol: 'LRCX', name: 'Lam Research', weight: 94 },
  { symbol: 'MMC', name: 'Marsh McLennan', weight: 92 },
  { symbol: 'PANW', name: 'Palo Alto Networks', weight: 90 },
  { symbol: 'CRWD', name: 'CrowdStrike', weight: 88 },
  { symbol: 'TGT', name: 'Target', weight: 86 },
  { symbol: 'CB', name: 'Chubb', weight: 84 },
  { symbol: 'MU', name: 'Micron', weight: 82 },
  { symbol: 'CI', name: 'Cigna', weight: 80 },
  { symbol: 'COP', name: 'ConocoPhillips', weight: 78 },
  { symbol: 'SO', name: 'Southern Company', weight: 76 },
  { symbol: 'DUK', name: 'Duke Energy', weight: 74 },
  { symbol: 'FDX', name: 'FedEx', weight: 72 },
  { symbol: 'SHOP', name: 'Shopify', weight: 70 },
  { symbol: 'COIN', name: 'Coinbase', weight: 68 },
  { symbol: 'ABNB', name: 'Airbnb', weight: 66 },
  { symbol: 'SQ', name: 'Block', weight: 64 },
  { symbol: 'DELL', name: 'Dell', weight: 62 },
  { symbol: 'SNOW', name: 'Snowflake', weight: 60 },
  { symbol: 'SPOT', name: 'Spotify', weight: 58 },
  { symbol: 'F', name: 'Ford', weight: 56 },
  { symbol: 'GM', name: 'General Motors', weight: 54 },
  { symbol: 'SNAP', name: 'Snap', weight: 52 },
  { symbol: 'DDOG', name: 'Datadog', weight: 50 },
  { symbol: 'NET', name: 'Cloudflare', weight: 48 },
  { symbol: 'RIVN', name: 'Rivian', weight: 46 },
  { symbol: 'ZS', name: 'Zscaler', weight: 44 },
];
